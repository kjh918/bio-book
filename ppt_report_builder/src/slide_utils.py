...
def fill_image(slide, shape: BaseShape, image_path: str,
                box: Optional[Tuple[int, int, int, int]] = None):
    ...
    height)` (EMU) to pin an explicit position/size instead. Returns the new
    picture shape."""
    ...
    return slide.shapes.add_picture(image_path, new_left, new_top, new_w, new_h)
